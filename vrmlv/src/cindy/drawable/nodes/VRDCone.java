...
public class VRDCone extends VRCone implements IDrawable{
	
	
	private static Logger _LOG = Logger.getLogger(VRDCone.class);
	...
	public NodeSettings getNodeSettings() {
		if (ns == null){
			...
			Vector3f v1 = new Vector3f(bottomRadius,bottomRadius,height);
			Vector3f v2 = new Vector3f(-bottomRadius,-bottomRadius,0);
